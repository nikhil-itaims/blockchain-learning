...
class Block:
    """ This class used to create a block """
    ...
    def calculate_hash(self):
        hash_string = f"{str(self.index)} {str(self.timestamp)} {str(self.data)} {str(self.previous_hash)}" 
        return hashlib.sha256(hash_string.encode()).hexdigest()

class Blockchain:
    """ This class used to create a blockchain """
